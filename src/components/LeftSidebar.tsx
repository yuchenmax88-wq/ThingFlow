...
export default function LeftSidebar() {
  ...
  return (
    <>
    <aside className="flex h-full w-64 shrink-0 flex-col overflow-hidden border-r border-border bg-card/30">
      {/* 项目区 */}
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* 配件列表 */}
        <div className="flex-1 space-y-1 overflow-y-auto overflow-x-hidden px-2 pb-3">
